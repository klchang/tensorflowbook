...
class PredictiveCodingModel:
    ...
    @lazy_property
    def mask(self):
        return tf.reduce_max(tf.abs(self.target), axis=2)

    @lazy_property
    def length(self):
        return tf.reduce_sum(self.mask, axis=1)
    ...
    def cost(self):
        ...
        cost = -tf.reduce_sum(cost, axis=2)
    ...
    def logprob(self):
        ...
        logprob = tf.reduce_max(logprob, axis=2)
    ...
    def _average(self, data):
        ...
        data = tf.reduce_sum(data, axis=1) / length
